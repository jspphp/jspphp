...
public class SjbTime {
	 ...
	 *            分钟
	 */
	public SjbTime(int hour, int minute) {
	 ...
	 *            秒
	 */
	public SjbTime(int hour, int minute, int second) {
	 ...
	 *            秒
	 */
	public SjbTime(int day, int hour, int minute, int second) {
		set(DAY, day);
		set(HOUR, hour);
		set(MINUTE, minute);
		set(SECOND, second);
	 ...
	 *            字符串格式的时间
	 */
	public SjbTime(String time, String timeSeparator) {
	 ...
	 * @return 运算后的时间
	 */
	public SjbTime addTime(SjbTime time) {
		SjbTime result = new SjbTime();
		int up = 0; // 进位标志
	 ...
	 * @return 运算后的时间
	 */
	public SjbTime subtractTime(SjbTime time) {
		SjbTime result = new SjbTime();
		int down = 0; // 退位标志
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final SjbTime other = (SjbTime) obj;
