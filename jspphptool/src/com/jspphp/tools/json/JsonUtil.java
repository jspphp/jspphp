...
public class JsonUtil {
	 ...
	 * @param clazz
	 * @param map
	 *            集合属性的类型 (key : 集合属性名, value : 集合属性类型class) eg: ("beansList" : Bean.class)
	 * @return
	 */
	...
	/**
	 * 把数据对象转换成json字符串 DTO对象形如：{"id" : idValue, "name" : nameValue, ...} 数组对象形如：[{}, {}, {}, ...] map对象形如：{key1 : {"id" : idValue, "name" : nameValue, ...},
	 * key2 : {}, ...}
	 * 
	 * @param object
	 * @return
